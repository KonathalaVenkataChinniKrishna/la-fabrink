...
@Component({
  selector: 'app-chatbotbothpage',
  templateUrl: './chatbotbothpage.component.html',
  styleUrls: ['./chatbotbothpage.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ChatbotbothpageComponent implements OnInit {
          ...
          this.sharedModule.getBotReply(this.botmsg).subscribe(data => {
            ...
            if (this.botmsg.substr(0, 1) === '{') {
              ...
              tmpHtml += '<div id="convpiece' + this.convcnt + '" class="col-lg-12 convpiece">'
                ...
                + '        <img src="./../../assets/images/lafabryk-img.png" alt="Avatar" style="width: 30px; height: 30px; border-radius: 50%;">'
                + '</div>'
